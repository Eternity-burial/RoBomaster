...
static const float chassis_lf_pid_kp = 0.05f;
static const float chassis_lf_pid_ki = 0.0f;
static const float chassis_lf_pid_kd = 0.0f;
static const float chassis_lf_maxout = 5.0f;
static const float chassis_lf_maxiout = 5.0f;
...
static const float chassis_lr_pid_kp = 0.0f;
static const float chassis_lr_pid_ki = 0.0f;
static const float chassis_lr_pid_kd = 0.0f;
static const float chassis_lr_maxout = 5.0f;
static const float chassis_lr_maxiout = 5.0f;
...
static const float chassis_rf_pid_kp = 0.0f;
static const float chassis_rf_pid_ki = 0.0f;
static const float chassis_rf_pid_kd = 0.0f;
static const float chassis_rf_maxout = 5.0f;
static const float chassis_rf_maxiout = 5.0f;
...
static const float chassis_rr_pid_kp = 0.0f;
static const float chassis_rr_pid_ki = 0.0f;
static const float chassis_rr_pid_kd = 0.0f;
static const float chassis_rr_maxout = 5.0f;
static const float chassis_rr_maxiout = 5.0f;
